...
| [DEERFLOW_WORK_MODULE.md](DEERFLOW_WORK_MODULE.md) | Generic work unit module and WorkBoard plan for PM-tool integration |
| [VISUAL_WORKFLOW_DESIGNER.md](VISUAL_WORKFLOW_DESIGNER.md) | Agent workflow definition and visual designer architecture |
...
├── DEERFLOW_WORK_MODULE.md    # Generic work unit and WorkBoard module plan
├── VISUAL_WORKFLOW_DESIGNER.md # Agent workflow definition/designer plan
