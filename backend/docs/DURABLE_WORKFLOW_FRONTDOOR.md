...
For deployments that need durable work management, this frontdoor should
be paired with the optional [DeerFlow Work Module](DEERFLOW_WORK_MODULE.md).
The frontdoor remains the generic intake and runtime-dispatch layer; the Work
module adds reusable work unit, acceptance criterion, gate, artifact reference,
review, and external PM-tool binding schemas.
